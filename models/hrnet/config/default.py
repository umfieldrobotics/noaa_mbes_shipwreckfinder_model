...
from models.hrnet.config.hrnet_config import MODEL_CONFIGS
...
_C.TRAIN.IMAGE_SIZE = [200, 200]  # width * height
...
_C.TEST.IMAGE_SIZE = [200, 200]  # width * height
...
def update_config(cfg, args):
    cfg.defrost()
    cfg.MODEL.EXTRA = MODEL_CONFIGS['hrnet48']  # or hrnet32, etc.
    cfg.freeze()
